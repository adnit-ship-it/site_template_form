    ...
    <div v-if="selectedProduct" class="space-y-4">
      ...
      <div class="space-y-4">
        ...
        <UiFrequencyCard v-if="getVariationPrice(selectedProduct, 'monthly') && !isMonthlyHidden" title="Monthly Plan"
                         ...
                         :savings-text="savingsTextFor(monthlySavings)"
        ...
        <UiFrequencyCard v-if="getVariationPrice(selectedProduct, 'twoMonthly')" title="2-Month Plan"
                         ...
                         :show-installments="true" :savings-text="savingsTextFor(twoMonthSavings)"
        ...
        <UiFrequencyCard v-if="getVariationPrice(selectedProduct, 'threeMonthly')" title="3-Month Plan"
                         ...
                         badge="Most Popular"
                         :show-installments="true" :savings-text="savingsTextFor(threeMonthSavings)"
        ...
        <UiFrequencyCard v-if="getVariationPrice(selectedProduct, 'fourMonthly')" title="4-Month Plan"
                         ...
                         :savings-text="savingsTextFor(fourMonthSavings)"
        ...
        <UiFrequencyCard v-if="getVariationPrice(selectedProduct, 'sixMonthly')" title="6-Month Plan"
                         ...
                         badge="Best Value" :show-installments="true"
                         :savings-text="savingsTextFor(sixMonthSavings)"
        ...
        <UiFrequencyCard v-if="getVariationPrice(selectedProduct, 'yearly')" title="12-Month Plan"
                         ...
                         :show-installments="true" :savings-text="savingsTextFor(yearlySavings)"
...
// Build the savings banner text for a given plan, or return '' to hide the banner
// when there's nothing to save. Empty string flips off `v-if="savingsText"` in
// `UiFrequencyCard`, so the green dashed-border block is removed entirely.
const savingsTextFor = (savings: number | undefined | null) => {
  if (!savings || savings <= 0) return ''
  return `You are saving $${formatSavings(savings)}`
}
