<template>
  <div class="pb-0 lg:pb-24 relative max-w-7xl mx-auto">
    ...
    <button @click="$emit('back')" type="button"
            class="fixed lg:static top-5 z-50 lg:top-0 left-1 min-[374px]:left-4 lg:left-0 lg:mb-0 mb-4 flex items-center justify-center w-6 min-[374px]:w-8 lg:w-10 h-6 min-[374px]:h-8 lg:h-10 rounded-full bg-white hover:bg-gray-50 transition-colors cursor-pointer shadow-sm"
            aria-label="Go back to quiz">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 min-[374px]:w-6 min-[374px]:h-6 text-bodyColor pointer-events-none"
    ...
    <!-- Plan Cards Layout -->
    <div class="flex flex-col gap-4 max-w-[686px] mx-auto mb-8">
