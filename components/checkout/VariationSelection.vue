    ...
    <div class="mt-8 max-w-[686px] mx-auto">
      ...
      <div v-show="isAllPlansExpanded" class="space-y-2 mt-3 pl-8 pr-4">
        <div class="flex items-start gap-3">
          <div class="w-[18px] h-[18px] flex-shrink-0 mt-0.5 rounded-full flex items-center justify-center bg-accentColor2">
            <img src="/assets/images/icons/empty-check.svg" alt="Check" class="w-2.5 h-2.5" />
          </div>
