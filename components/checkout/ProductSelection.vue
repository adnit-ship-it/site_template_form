...
// Reactive categories from the DB-backed catalog (populated by
// `plugins/02.products-catalog.ts`). Vue auto-unwraps the ref in templates,
// so the existing `v-for="category in categories"` keeps working.
