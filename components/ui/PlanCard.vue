<template>
  <div @click="handleClick" @keydown.enter="handleClick" @keydown.space.prevent="handleClick"
    ...
    <div v-if="isSelected"
      class="absolute top-4 right-4 w-6 h-6 rounded-full bg-accentColor2 flex items-center justify-center transition-colors duration-300">
      <img src="/assets/images/icons/empty-check.svg" alt="Selected" class="w-3 h-3" />
    </div>
