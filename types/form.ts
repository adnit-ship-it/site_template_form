...
export interface FormStep {
  ...
  // Per-step disqualification — fires immediately after the step is completed
  checkDisqualify?: boolean;
  disqualifyMessage?: { title: string; subtitle: string; showBackButton?: boolean };
  disqualifyCondition?: (answers: FormAnswers) => boolean;
}
