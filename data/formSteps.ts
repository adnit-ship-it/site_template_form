...
export const glp1Steps: FormStep[] = [
  {
    ...
    checkDisqualify: true,
    disqualifyCondition: (answers: any) => {
      const feet = Number(answers.feet);
      const inches = Number(answers.inches);
      const weight = Number(answers.weight);
      if (!feet || !weight) return false;
  ...
  },
  {
    ...
    heading: "For your safety",
    checkDisqualify: true,
    disqualifyCondition: (answers: any) => {
      return !!(answers.pregnancyStatus && answers.pregnancyStatus !== "None of the above");
    },
    disqualifyMessage: {
      title: "We're sorry, you're not eligible at this time",
      subtitle:
    ...
    subtext: "<span style='font-weight:500;font-size:18px;line-height:28px'>Please select any that apply to you</span>",
    questionsPerRow: 1,
    questions: [
      {
        id: "pregnancyStatus",
  ...
  },
  {
    ...
    heading: "Medical history: Serious conditions",
    subtext: "<span style='font-weight:500;font-size:18px;line-height:28px'>Please select all that apply to you</span>",
    checkDisqualify: true,
    disqualifyCondition: (answers: any) => {
      const critical = [
        ...
        "Use of the blood thinner Cap Warfarin (Coumadin/Jantoven)",
        "Cancer (active diagnosis, ongoing treatment, in remission, or cancer-free for less than 5 consecutive years; excludes non-melanoma skin cancers successfully removed by simple excision)",
      ];
      const selected: string[] = Array.isArray(answers.medicalConditions1) ? answers.medicalConditions1 : [];
      return selected.some((a) => critical.includes(a));
    },
    disqualifyMessage: {
      title: "We're sorry, you're not eligible at this time",
      subtitle:
    ...
    questions: [
      {
        ...
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "Medical history: Serious conditions",
        options: [
          "None of these",
          "End-stage kidney disease (on or about to be on dialysis)",
          "End-stage liver disease (cirrhosis)",
  ...
  // Question 13: Medical Conditions 2
  {
    ...
    heading: "Medical history: Current health diagnoses",
    subtext: "<span style='font-weight:500;font-size:18px;line-height:28px'>Please select all that apply to you</span>",
    checkDisqualify: true,
    disqualifyCondition: (answers: any) => {
      const critical = [
      ...
      const selected: string[] = Array.isArray(answers.medicalConditions2) ? answers.medicalConditions2 : [];
      return selected.some((a) => critical.includes(a));
    },
    disqualifyMessage: {
      title: "We're sorry, you're not eligible at this time",
    ...
    questions: [
      {
        ...
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "Medical history: Current health diagnoses",
        options: [
          "None of these",
          ...
          "Type 2 diabetes (on insulin)",
          "Type 1 diabetes",
          "Diabetic retinopathy (diabetic eye disease), damage to the optic nerve from trauma or reduced blood flow, blindness",
          "History of or current pancreatitis",
          "Personal or family history of Medullary Thyroid Carcinoma (MTC) or Multiple Endocrine Neoplasia Syndrome Type 2 (MEN-2)",
  ...
  // Question 13b: Medical Conditions 3 — Mental health screening
  {
    id: "medicalConditions3",
    heading: "Medical history: Mental health screening",
    subtext: "<span style='font-weight:500;font-size:18px;line-height:28px'>Please select all that apply to you</span>",
    checkDisqualify: true,
    disqualifyCondition: (answers: any) => {
      const critical = [
      ...
      const selected: string[] = Array.isArray(answers.medicalConditions3) ? answers.medicalConditions3 : [];
      return selected.some((a) => critical.includes(a));
    },
    disqualifyMessage: {
      title: "We're sorry, you're not eligible at this time",
    ...
    questions: [
      {
        ...
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "Medical history: Mental health screening",
        options: [
          "None of these",
          "Severe depression",
          "Are you currently experiencing suicidal thoughts or have had a prior suicide attempt?",
          "Current diagnosis of or treatment for alcohol, opioid, or substance use disorder/dependence",
        ],
        required: true,
        displayAsRow: true,
...
// Skin Care Intake Form Steps
// Note: age / DOB are captured by `contactFormSteps` (the `dob` step), so the
// quiz itself starts at BMI per the brief.
export const skinSteps: FormStep[] = [
  {
    id: "heightWeight",
    title: "What is your height and weight?",
    heading: "BMI Calculation",
  ...
  {
    id: "skinPriorityGoal",
    heading: "Which skincare goal is most important to you?",
    questions: [
      {
        id: "skinPriorityGoal",
        type: "SINGLESELECT",
        displayQuestion: " ",
        question: "Which skincare goal is most important to you?",
        displayAsRow: true,
        options: [
          "Reducing fine lines and wrinkles",
          "Improving skin texture (finer, smoother skin)",
          "Controlling/preventing acne breakouts",
  ...
  {
    id: "skinOtherGoals",
    heading: "What other goals do you have for your skin? Please select all that apply.",
    questions: [
      {
        id: "skinOtherGoals",
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "What other goals do you have for your skin? Please select all that apply.",
        displayAsRow: true,
        options: [
          "Reducing fine lines and wrinkles",
          "Improving skin texture (finer, smoother skin)",
  ...
  {
    id: "skinDryness",
    heading: "Please select how dry/oily your skin is.",
    questions: [
      {
        id: "skinDryness",
        type: "SINGLESELECT",
        displayQuestion: " ",
        question: "Please select how dry/oily your skin is.",
        displayAsRow: true,
        options: [
          "Very dry",
          "Somewhat dry",
  ...
  {
    id: "usingTretinoin",
    heading: "Are you currently using tretinoin, retin-A, or other retinol product?",
    questions: [
      {
        id: "usingTretinoin",
        type: "YESNO",
        displayQuestion: " ",
        question: "Are you currently using tretinoin, retin-A, or other retinol product?",
        options: ["Yes", "No"],
        required: true,
        apiType: "SINGLESELECT",
      },
  ...
  },
  {
    ...
    renderCondition: (answers: any) => answers.usingTretinoin === "Yes",
    heading: "What strength tretinoin or retin-A are you using?",
    questions: [
      {
        id: "tretinoinStrength",
        type: "SINGLESELECT",
        displayQuestion: " ",
        question: "What strength tretinoin or retin-A are you using?",
        displayAsRow: true,
        options: [
          "0.025%",
          "0.05%",
  ...
  {
    id: "skinConditions",
    heading: "Do you have any of the following skin conditions? Please select all that apply.",
    questions: [
      {
        id: "skinConditions",
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "Do you have any of the following skin conditions? Please select all that apply.",
        displayAsRow: true,
        options: [
          "Acne",
          "Rosacea",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "skinCurrentConditionsDetails",
        renderCondition: (answers: any) => answers.skinCurrentConditions === "Yes",
        question: "Please list all current medical conditions",
        displayQuestion: "Please list all current medical conditions",
        type: "textarea",
        required: true,
  ...
  {
    id: "skinTopicalAllergies",
    heading: "Are you allergic or sensitive to any of the following topical products? Please select all that apply.",
    questions: [
      {
        id: "skinTopicalAllergies",
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "Are you allergic or sensitive to any of the following topical products? Please select all that apply.",
        displayAsRow: true,
        options: [
          "Tretinoin",
          "Niacinamide",
  ...
  {
    id: "skinAllergies",
    heading: "Do you have any allergies to prescription or over-the-counter medicines, herbs, vitamins, supplements, food, dyes, or anything else?",
    questionsPerRow: 1,
    questions: [
      {
        id: "skinAllergies",
      ...
      {
        id: "skinAllergiesDetails",
        renderCondition: (answers: any) => answers.skinAllergies === "Yes",
        question: "Please list all of your allergies",
        displayQuestion: "Please list all of your allergies",
        type: "textarea",
        required: true,
  ...
  {
    id: "skinMedications",
    heading: "Are you currently taking any prescription or over-the-counter medications or supplements?",
    questionsPerRow: 1,
    questions: [
      {
        id: "skinMedications",
      ...
      {
        id: "skinMedicationsDetails",
        renderCondition: (answers: any) => answers.skinMedications === "Yes",
        question: "Please list all medications and supplements with dosages",
        displayQuestion: "Please list all medications and supplements with dosages",
        type: "textarea",
        required: true,
  ...
  {
    id: "skincareUsage",
    heading: "Which of the following do you use? Please select all that apply.",
    questionsPerRow: 1,
    questions: [
      {
        id: "skincareUsage",
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "Which of the following do you use? Please select all that apply.",
        displayAsRow: true,
        options: [
          "Sunscreen",
          "Moisturizer",
      ...
      },
      {
        id: "skincareProducts",
        renderCondition: (answers: any) =>
          Array.isArray(answers.skincareUsage) && answers.skincareUsage.includes("Other"),
        question: "Please list all other skincare products you are using",
        displayQuestion: "Please list all other skincare products you are using",
        type: "textarea",
        required: true,
        placeholder: "List your other skincare products",
        apiType: "TEXT",
      },
    ],
  },
  {
    id: "skinAdditionalInfo",
    heading: "Is there anything else you want to tell your doctor?",
    questionsPerRow: 1,
    questions: [
      {
      ...
      {
        id: "skinAdditionalInfoDetails",
        renderCondition: (answers: any) => answers.skinAdditionalInfo === "Yes",
        question: "Please share anything else you'd like your doctor to know",
        displayQuestion: "Please share anything else you'd like your doctor to know",
        type: "textarea",
        required: true,
        placeholder: "Any additional information for your doctor",
        apiType: "TEXT",
...
// Hair Loss Intake Form Steps
// Note: age / DOB are captured by `contactFormSteps` (the `dob` step), so the
// quiz itself does not ask for them.
export const hairSteps: FormStep[] = [
  {
    id: "heightWeight",
    title: "What is your height and weight?",
    heading: "BMI Calculation",
  ...
  {
    id: "hairSatisfaction",
    heading: "How satisfied are you with your hair overall?",
    questions: [
      {
        id: "hairSatisfaction",
        type: "SINGLESELECT",
        displayQuestion: " ",
        question: "How satisfied are you with your hair overall?",
        displayAsRow: true,
        options: [
          "Not at all",
          "A little bit",
  ...
  {
    id: "hairLossGoals",
    heading: "What are your top-priority goals for hair loss treatment?",
    questions: [
      {
        id: "hairLossGoals",
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "What are your top-priority goals for hair loss treatment?",
        displayAsRow: true,
        options: [
  ...
  {
    id: "hairLossLocation",
    heading: "Where are you noticing hair loss or thinning?",
    questions: [
      {
        id: "hairLossLocation",
        type: "SINGLESELECT",
        displayQuestion: " ",
        question: "Where are you noticing hair loss or thinning?",
        displayAsRow: true,
        options: [
  ...
  {
    id: "hairTreatmentHistory",
    heading: "Have you ever treated your hair loss with medication?",
    questions: [
      {
        id: "hairTreatmentHistory",
        type: "YESNO",
        displayQuestion: " ",
        question: "Have you ever treated your hair loss with medication?",
        options: ["Yes", "No"],
        required: true,
        apiType: "SINGLESELECT",
      },
  ...
  {
    id: "hairTreatmentReceived",
    renderCondition: (answers: any) => answers.hairTreatmentHistory === "Yes",
    heading: "What treatments did you receive?",
    questions: [
      {
        id: "hairTreatmentReceived",
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "What treatments did you receive?",
        displayAsRow: true,
        options: [
          "Oral minoxidil",
  ...
  {
    id: "hairTreatmentExperience",
    renderCondition: (answers: any) => answers.hairTreatmentHistory === "Yes",
    heading: "Please tell us more about your treatment experience (effectiveness, side effects, etc.).",
    questions: [
      {
        id: "hairTreatmentExperience",
        type: "textarea",
        displayQuestion: " ",
        question: "Please tell us more about your treatment experience (effectiveness, side effects, etc.).",
        required: true,
        placeholder: "Describe effectiveness, side effects, and anything else worth noting",
        apiType: "TEXT",
      },
    ],
  },
  {
    ...
    heading: "Have you noticed any of the following?",
    questions: [
      {
        id: "hairScalpSymptoms",
        type: "MULTISELECT",
  ...
  {
    id: "hairMedicalConditions",
    heading: "Do you have, or have you ever had, any of the following conditions?",
    questions: [
      {
        id: "hairMedicalConditions",
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "Do you have, or have you ever had, any of the following conditions?",
        displayAsRow: true,
        options: [
          "Heart failure",
          "Pericarditis",
  ...
  {
    id: "hairCurrentMedications",
    heading: "Are you currently taking any prescription medications, over-the-counter medications, vitamins, dietary supplements, or topical creams?",
    questionsPerRow: 1,
    questions: [
      {
        id: "hairCurrentMedications",
        displayQuestion: " ",
        question: "Medications and supplements",
        type: "YESNO",
        options: ["Yes", "No"],
        required: true,
        apiType: "SINGLESELECT",
      ...
      {
        id: "hairCurrentMedicationsDetails",
        renderCondition: (answers: any) => answers.hairCurrentMedications === "Yes",
        question: "Please list everything you're taking or using, including dosages",
        displayQuestion: "Please list everything you're taking or using, including dosages",
        type: "textarea",
        required: true,
        placeholder: "List medications, supplements, and topical creams with dosages",
        apiType: "TEXT",
      },
    ],
  },
  {
    id: "hairTopicalAllergies",
    heading: "Are you allergic to any of the following? Please select all that apply.",
    questions: [
      {
        id: "hairTopicalAllergies",
        type: "MULTISELECT",
        displayQuestion: " ",
        question: "Are you allergic to any of the following? Please select all that apply.",
        displayAsRow: true,
        options: [
  ...
  {
    id: "hairAllergies",
    heading: "Do you have any known allergies?",
    questionsPerRow: 1,
    questions: [
      {
        id: "hairAllergies",
      ...
      {
        id: "hairAllergiesDetails",
        renderCondition: (answers: any) => answers.hairAllergies === "Yes",
        question: "Please list all of your known allergies",
        displayQuestion: "Please list all of your known allergies",
        type: "textarea",
        required: true,
        placeholder: "List all known allergies",
        apiType: "TEXT",
  ...
  {
    id: "hairAdditionalInfoYesNo",
    questionsPerRow: 1,
    heading: "Is there anything else you want your doctor to know about your condition or health?",
    questions: [
      {
        id: "hairAdditionalInfoYesNo",
        type: "YESNO",
        displayQuestion: " ",
        question: "Is there anything else you want your doctor to know about your condition or health?",
        options: ["Yes", "No"],
        required: true,
        apiType: "SINGLESELECT",
      },
      {
        id: "hairProviderMessage",
        type: "textarea",
        renderCondition: (answers: any) => answers.hairAdditionalInfoYesNo === "Yes",

        displayQuestion: " ",
        question: "Please leave your message to your doctor here.",
        required: true,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "CHECKBOX",
        required: false,
        // The Checkbox component renders this label via `v-html`, so anchor
        // tags work. `onclick="event.stopPropagation()"` keeps clicks on the
        // links from bubbling to the wrapping <label> and toggling the
        // checkbox. `target="_blank"` so the user doesn't lose quiz progress.
        options: [`I consent to receive marketing text messages from {{orgName}} at the phone number provided, including promotions, discounts, and product/service updates. Msg frequency varies. Msg & data rates may apply. Reply HELP for help, STOP to opt out. Consent is not a condition of purchase. See <a href="/terms" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()" class="underline text-accentColor1 hover:opacity-80">Terms</a> and <a href="/privacy" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()" class="underline text-accentColor1 hover:opacity-80">Privacy Policy</a>.`],
        apiType: "SINGLESELECT",
      },
    ],
  },
